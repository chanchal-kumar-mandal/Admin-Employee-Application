			...
			echo '<div class="panel '.$panelClass.'">
				<div class="panel-heading">
			  	...
			  	<div class="panel-footer">
					...
					<div class="col-md-4 rating-select">
					...
					<div class="col-md-4 text-right">
				  		<button type="button" class="btn btn-xs btn-warning"  data-toggle="modal" data-target="#editFAQModal' . $faqResult['id'] . '"><span class="glyphicon glyphicon-edit"></span> Edit</button>
						...
						<button type="button" class="btn btn-xs btn-info"><a href="#"><span class="glyphicon glyphicon-ok"></span> Like</a></button>
					</div>
					</div>
			  	</div>
			</div>
