...
?>
	<div class="page-container">
		<div class="col-md-6">
			<button type="button" class="btn btn-xs btn-success" style="float:right" data-toggle="modal" data-target="#createFAQCategoryModal"><span class="glyphicon glyphicon-plus"></span> Create FAQ Category</button>
			<table class="table table-bordered table-hover pull-right">	  
				...
				foreach($faqCategoryResult as $category){
					...
					echo '<tr ">
						...
						<td>
							<button type="button" class="btn btn-xs btn-warning"  data-toggle="modal" data-target="#editFAQCategoryModal' . $category['id'] . '"><span class="glyphicon glyphicon-edit"></span> Edit</button>
							<button type="button" class="btn btn-xs btn-danger"><a href="#" onclick="return checkDelete()"><span class="glyphicon glyphicon-remove"></span> Delete</a></button>
						</td>
					</tr>
					      	...
					      	<div class="modal-content">
					        	...
					        	<div class="modal-body">
					        		<form role="form" action="edit-faq-category.php" method="post">
										...
										<button type="submit" class="btn btn-xs btn-primary" name="editFAQCategory">Submit</button>
									</form>
					        	</div>
		...
		<div class="col-md-6">
			<div class="row"><button type="button" class="btn btn-xs btn-success" style="float:right" data-toggle="modal" data-target="#createFAQModal"><span class="glyphicon glyphicon-plus"></span> Create FAQ</button></div>
		      	...
		      	<div class="modal-content">
		        	...
		        	<div class="modal-body">
		        		<form role="form" action="create-faq-category.php" method="post">
							...
							<button type="submit" class="btn btn-xs btn-primary" name="createFAQCategory">Submit</button>
						</form>
		        	</div>
		        	<div class="modal-footer">
		          		<button type="button" class="btn btn-xs btn-default" data-dismiss="modal">Close</button>
		      	...
		      	<div class="modal-content">
		        	...
		        	<div class="modal-body">
		        		<form role="form" action="create-faq.php" method="post">
							...
							<button type="submit" class="btn btn-xs btn-primary" name="createFAQ">Submit</button>
						</form>
		        	</div>
		        	<div class="modal-footer">
		          		<button type="button" class="btn btn-xs btn-default" data-dismiss="modal">Close</button>
